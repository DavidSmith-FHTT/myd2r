...
import numpy as np
import random
from ablation.models.unimo_model_ablation_imrc import UnimoModelF
...
def main():
    ...
    parser.add_argument('--save_path', default='/home/ningwang/SSD1T/cts/model_reproduction/D2R/output/Multiple_ablation_imrc/', type=str, help="save best model at save_path")
    ...
    logger.info(args)
    logger.info("=" * 50)
    logger.info("消融实验：移除IntraModelReasoningCell (USSR单元) - MVSA-Multiple数据集")
    logger.info("=" * 50)
