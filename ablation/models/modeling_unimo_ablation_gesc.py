...
from ablation.models.InteractionModule_ablation_gesc import InteractionModule, Reversed_InteractionModule
...
class UnimoModel(nn.Module):
    """
    消融实验版本：移除GlobalEnhancedSemanticCell，使用5个单元而非6个
    """
