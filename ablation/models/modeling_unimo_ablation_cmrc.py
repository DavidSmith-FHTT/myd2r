...
from ablation.models.InteractionModule_ablation_cmrc import InteractionModule, Reversed_InteractionModule
...
class UnimoModel(nn.Module):
    """
    消融实验版本：移除CrossModalRefinementCell，使用5个单元而非6个
    """
    def __init__(self, args, vision_config, text_config, add_pooling_layer=True, num_self_layer=1):
        ...
        # 消融实验：使用5个单元的InteractionModule（移除CrossModalRefinementCell）
