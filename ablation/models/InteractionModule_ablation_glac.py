...
from ablation.models.DynamicInteraction_ablation_glac import DynamicInteraction_Layer0, DynamicInteraction_Layer, Reversed_DynamicInteraction_Layer0, Reversed_DynamicInteraction_Layer


class InteractionModule(nn.Module):
    """
    Dynamic Sentiment Interaction Module overall architecture(以文本为中心)
    消融实验：移除GlobalLocalAlignmentCell，从6个单元减少到5个
    Args:
