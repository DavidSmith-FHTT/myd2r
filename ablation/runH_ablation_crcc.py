...
def main():
    ...
    parser.add_argument('--save_path', default='/home/ningwang/SSD1T/cts/model_reproduction/D2R/output/HFM_ablation_crcc/', type=str, help="save best model at save_path")
    ...
    logger.info(args)
    logger.info("=" * 50)
    logger.info("消融实验：移除ContextRichCrossModalCell (MVSSU单元) - HFM数据集")
    logger.info("=" * 50)
