...
def main():
    ...
    parser.add_argument('--save_path', default='/home/ningwang/SSD1T/cts/model_reproduction/D2R/output/Single_ablation_cmrc/', type=str, help="save best model at save_path")
    ...
    logger.info(args)
    logger.info("=" * 50)
    logger.info("消融实验：移除CrossModalRefinementCell (CLSSM单元) - MVSA-Single数据集")
    logger.info("=" * 50)
